...
import { hyperspeedPresets } from "../components/background/presets";
...
function Login() {
  ...
  const handleChange = (e) => {
    ...
    setFormData({
      ...formData, // Keeps all previous fields and updates the one that was typed.
      [name]: value
    });
  };
  ...
  return (
    <div className="position-relative  min-vh-100">
      ...
      {/* Login Container */}
      <div className="container d-flex align-items-center justify-content-center h-100 position-relative" style={{ zIndex: 1 }}>
        <div className="card shadow-lg p-4" style={{ maxWidth: '400px', width: '100%', backgroundColor: 'rgba(255, 255, 255, 0.8)', borderRadius: '12px' }}>
          <h2 className="text-center mb-4 fw-bold text-primary">Login to Continue</h2>
          ...
          <div className="text-center">
            <div className="my-3 d-flex align-items-center text-muted">
...
// --- -----------------------------------for studying see this down code this is code same as above the deffrence is css only 
// import { useState } from "react";
// import axios from "axios";
// import { GoogleOAuthProvider, GoogleLogin } from '@react-oauth/google';
// import { useDispatch } from "react-redux";
...
//     setFormData({
//       ...formData,                    // why spread opt^r , becoz :-Keeps all previous fields and updates the one that was typed.   
//       [name]: value
//     });
//   };
...
//     if (formData.password.length === 0) {
//       isValid = false;
//       newErrors.password = "Password is mandatory";      // errors.username and errors.password — Field-Level Errors
//     }
...
//       } catch (error) {
//         console.log(error);
//         setErrors({ message: 'something went wrong' });          //errors.message global error 
//       }
//     }
//   };
